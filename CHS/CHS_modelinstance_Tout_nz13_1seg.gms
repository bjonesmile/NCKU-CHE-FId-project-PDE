...
*    sym_bc(T).. bc_L(T) =e= bc_R(T);
    ...
    BC_L1(T)$(ord(T) lt 26).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 26) and (ord(T) lt 53))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 53) and (ord(T) lt 80))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 80) and (ord(T) lt 107))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 107) and (ord(T) lt 134))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 134) and (ord(T) lt 161))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 161) and (ord(T) lt 188))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 188) and (ord(T) lt 215))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 215) and (ord(T) lt 242))..                BC_L(T) =e= BC_L(T+1);
    BC_L10(T)$((ord(T) gt 242) and (ord(T) lt 269))..                BC_L(T) =e= BC_L(T+1);
    BC_L11(T)$((ord(T) gt 269) and (ord(T) lt 296))..                BC_L(T) =e= BC_L(T+1);
    BC_L12(T)$((ord(T) gt 296) and (ord(T) lt 323))..                BC_L(T) =e= BC_L(T+1);
    BC_L13(T)$((ord(T) gt 323) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 26).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 26) and (ord(T) lt 53))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 53) and (ord(T) lt 80))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 80) and (ord(T) lt 107))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 107) and (ord(T) lt 134))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 134) and (ord(T) lt 161))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 161) and (ord(T) lt 188))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 188) and (ord(T) lt 215))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 215) and (ord(T) lt 242))..                BC_R(T) =e= BC_R(T+1);
    BC_R10(T)$((ord(T) gt 242) and (ord(T) lt 269))..                BC_R(T) =e= BC_R(T+1);
    BC_R11(T)$((ord(T) gt 269) and (ord(T) lt 296))..                BC_R(T) =e= BC_R(T+1);
    BC_R12(T)$((ord(T) gt 296) and (ord(T) lt 323))..                BC_R(T) =e= BC_R(T+1);
    BC_R13(T)$((ord(T) gt 323) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
    eobj .. obj =e= FId;
