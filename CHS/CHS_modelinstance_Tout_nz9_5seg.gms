...
*   For_u(X,T)$(region(X,T)) ..  u(X,T+1) =e= u(X,T-1)+alpha(T)*r1*(u(X-1,T)-2*u(X,T)+u(X+1,T))-v*r2*(u(X+1,T)-u(X-1,T))-c*2*dt*(u(X,T)-k0) ;
    ...
    BC_L1(T)$(ord(T) lt 38).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 38) and (ord(T) lt 77))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 77) and (ord(T) lt 116))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 116) and (ord(T) lt 155))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 155) and (ord(T) lt 194))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 194) and (ord(T) lt 233))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 233) and (ord(T) lt 272))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 272) and (ord(T) lt 311))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 311) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 38).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 38) and (ord(T) lt 77))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 77) and (ord(T) lt 116))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 116) and (ord(T) lt 155))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 155) and (ord(T) lt 194))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 194) and (ord(T) lt 233))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 233) and (ord(T) lt 272))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 272) and (ord(T) lt 311))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 311) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
