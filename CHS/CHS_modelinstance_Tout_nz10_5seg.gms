...
*   For_u(X,T)$(region(X,T)) ..  u(X,T+1) =e= u(X,T-1)+alpha(T)*r1*(u(X-1,T)-2*u(X,T)+u(X+1,T))-v*r2*(u(X+1,T)-u(X-1,T))-c*2*dt*(u(X,T)-k0) ;
    ...
    BC_L1(T)$(ord(T) lt 35).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 35) and (ord(T) lt 70))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 70) and (ord(T) lt 105))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 105) and (ord(T) lt 140))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 140) and (ord(T) lt 175))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 175) and (ord(T) lt 210))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 210) and (ord(T) lt 245))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 245) and (ord(T) lt 280))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 280) and (ord(T) lt 315))..                BC_L(T) =e= BC_L(T+1);
    BC_L10(T)$((ord(T) gt 315) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 35).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 35) and (ord(T) lt 70))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 70) and (ord(T) lt 105))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 105) and (ord(T) lt 140))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 140) and (ord(T) lt 175))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 175) and (ord(T) lt 210))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 210) and (ord(T) lt 245))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 245) and (ord(T) lt 280))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 280) and (ord(T) lt 315))..                BC_R(T) =e= BC_R(T+1);
    BC_R10(T)$((ord(T) gt 315) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
    eobj .. obj =e= FId;
