...
*    sym_bc(T).. bc_L(T) =e= bc_R(T);
    ...
    BC_L1(T)$(ord(T) lt 25).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 25) and (ord(T) lt 50))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 50) and (ord(T) lt 75))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 75) and (ord(T) lt 100))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 100) and (ord(T) lt 125))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 125) and (ord(T) lt 150))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 150) and (ord(T) lt 175))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 175) and (ord(T) lt 200))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 200) and (ord(T) lt 225))..                BC_L(T) =e= BC_L(T+1);
    BC_L10(T)$((ord(T) gt 225) and (ord(T) lt 250))..                BC_L(T) =e= BC_L(T+1);
    BC_L11(T)$((ord(T) gt 250) and (ord(T) lt 275))..                BC_L(T) =e= BC_L(T+1);
    BC_L12(T)$((ord(T) gt 275) and (ord(T) lt 300))..                BC_L(T) =e= BC_L(T+1);
    BC_L13(T)$((ord(T) gt 300) and (ord(T) lt 325))..                BC_L(T) =e= BC_L(T+1);
    BC_L14(T)$((ord(T) gt 325) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 25).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 25) and (ord(T) lt 50))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 50) and (ord(T) lt 75))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 75) and (ord(T) lt 100))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 100) and (ord(T) lt 125))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 125) and (ord(T) lt 150))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 150) and (ord(T) lt 175))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 175) and (ord(T) lt 200))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 200) and (ord(T) lt 225))..                BC_R(T) =e= BC_R(T+1);
    BC_R10(T)$((ord(T) gt 225) and (ord(T) lt 250))..                BC_R(T) =e= BC_R(T+1);
    BC_R11(T)$((ord(T) gt 250) and (ord(T) lt 275))..                BC_R(T) =e= BC_R(T+1);
    BC_R12(T)$((ord(T) gt 275) and (ord(T) lt 300))..                BC_R(T) =e= BC_R(T+1);
    BC_R13(T)$((ord(T) gt 300) and (ord(T) lt 325))..                BC_R(T) =e= BC_R(T+1);
    BC_R14(T)$((ord(T) gt 325) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
