...
*   For_u(X,T)$(region(X,T)) ..  u(X,T+1) =e= u(X,T-1)+alpha(T)*r1*(u(X-1,T)-2*u(X,T)+u(X+1,T))-v*r2*(u(X+1,T)-u(X-1,T))-c*2*dt*(u(X,T)-k0) ;
    ...
    BC_L1(T)$(ord(T) lt 50).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 50) and (ord(T) lt 100))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 100) and (ord(T) lt 150))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 150) and (ord(T) lt 200))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 200) and (ord(T) lt 250))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 250) and (ord(T) lt 300))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 300) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 50).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 50) and (ord(T) lt 100))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 100) and (ord(T) lt 150))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 150) and (ord(T) lt 200))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 200) and (ord(T) lt 250))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 250) and (ord(T) lt 300))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 300) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
