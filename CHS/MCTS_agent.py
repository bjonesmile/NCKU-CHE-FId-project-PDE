...
for up in Uncertain_parameter_name:
    ...
    nzLimitList[up] = nz*proble_Nz+1

var_num = len(Uncertain_parameter_name)
GAMSfile = "CHS_modelinstance_Tout_nz"+str(proble_Nz)+"_"+str(var_num)+"seg.gms"
...
class State(object):
    def __init__(self,ucps = ['Tout_x2', 'Tout_x3', 'Tout_x4', 'Tout_x5', 'Tout_x6', 'Tout_x7', 'Tout_x8', 'Tout_x9', 'Tout_x10']):
...
def monte_carlo_tree_search(node,computation_budget = 1000):
    ...
    first step and second step: use tree policy find sub-node worth to expolre.
...
if __name__ == "__main__":
    ...
    if op_cmd == "MCTS" :
        ...
        MCTS_result = main()
        print("Simulation: Nz",proble_Nz,"suc")
        print(StartDirect)
        print(MCTS_result)
