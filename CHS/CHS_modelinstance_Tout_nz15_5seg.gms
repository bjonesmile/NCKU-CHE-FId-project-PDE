...
Equations
    ...
    Tout_uncertain_x2(X,T)  ..  Tout('x2',T) =e= Tout_n+0.5*FId*Tout_x2_vertex(T) ;
    Tout_uncertain_x3(X,T)  ..  Tout('x3',T) =e= Tout_n+0.5*FId*Tout_x34_vertex(T) ;
    Tout_uncertain_x4(X,T)  ..  Tout('x4',T) =e= Tout_n+0.5*FId*Tout_x34_vertex(T) ;
    ...
    Tout_uncertain_x8(X,T)  ..  Tout('x8',T) =e= Tout_n+0.5*FId*Tout_x89_vertex(T) ;
    Tout_uncertain_x9(X,T)  ..  Tout('x9',T) =e= Tout_n+0.5*FId*Tout_x89_vertex(T) ;
    Tout_uncertain_x10(X,T) ..  Tout('x10',T)=e= Tout_n+0.5*FId*Tout_x10_vertex(T) ;
...
*   For_u(X,T)$(region(X,T)) ..  u(X,T+1) =e= u(X,T-1)+alpha(T)*r1*(u(X-1,T)-2*u(X,T)+u(X+1,T))-v*r2*(u(X+1,T)-u(X-1,T))-c*2*dt*(u(X,T)-k0) ;
    ...
    BC_L1(T)$(ord(T) lt 23).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 23) and (ord(T) lt 46))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 46) and (ord(T) lt 70))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 70) and (ord(T) lt 93))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 93) and (ord(T) lt 116))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 116) and (ord(T) lt 140))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 140) and (ord(T) lt 163))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 163) and (ord(T) lt 186))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 186) and (ord(T) lt 210))..                BC_L(T) =e= BC_L(T+1);
    BC_L10(T)$((ord(T) gt 210) and (ord(T) lt 233))..                BC_L(T) =e= BC_L(T+1);
    BC_L11(T)$((ord(T) gt 233) and (ord(T) lt 256))..                BC_L(T) =e= BC_L(T+1);
    BC_L12(T)$((ord(T) gt 256) and (ord(T) lt 280))..                BC_L(T) =e= BC_L(T+1);
    BC_L13(T)$((ord(T) gt 280) and (ord(T) lt 303))..                BC_L(T) =e= BC_L(T+1);
    BC_L14(T)$((ord(T) gt 303) and (ord(T) lt 326))..                BC_L(T) =e= BC_L(T+1);
    BC_L15(T)$((ord(T) gt 326) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 23).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 23) and (ord(T) lt 46))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 46) and (ord(T) lt 70))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 70) and (ord(T) lt 93))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 93) and (ord(T) lt 116))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 116) and (ord(T) lt 140))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 140) and (ord(T) lt 163))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 163) and (ord(T) lt 186))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 186) and (ord(T) lt 210))..                BC_R(T) =e= BC_R(T+1);
    BC_R10(T)$((ord(T) gt 210) and (ord(T) lt 233))..                BC_R(T) =e= BC_R(T+1);
    BC_R11(T)$((ord(T) gt 233) and (ord(T) lt 256))..                BC_R(T) =e= BC_R(T+1);
    BC_R12(T)$((ord(T) gt 256) and (ord(T) lt 280))..                BC_R(T) =e= BC_R(T+1);
    BC_R13(T)$((ord(T) gt 280) and (ord(T) lt 303))..                BC_R(T) =e= BC_R(T+1);
    BC_R14(T)$((ord(T) gt 303) and (ord(T) lt 326))..                BC_R(T) =e= BC_R(T+1);
    BC_R15(T)$((ord(T) gt 326) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
    eobj .. obj =e= FId;
