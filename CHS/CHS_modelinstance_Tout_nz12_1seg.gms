...
*    sym_bc(T).. bc_L(T) =e= bc_R(T);
    ...
    BC_L1(T)$(ord(T) lt 29).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 29) and (ord(T) lt 58))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 58) and (ord(T) lt 87))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 87) and (ord(T) lt 116))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 116) and (ord(T) lt 145))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 145) and (ord(T) lt 175))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 175) and (ord(T) lt 204))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 204) and (ord(T) lt 233))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 233) and (ord(T) lt 262))..                BC_L(T) =e= BC_L(T+1);
    BC_L10(T)$((ord(T) gt 262) and (ord(T) lt 291))..                BC_L(T) =e= BC_L(T+1);
    BC_L11(T)$((ord(T) gt 291) and (ord(T) lt 320))..                BC_L(T) =e= BC_L(T+1);
    BC_L12(T)$((ord(T) gt 320) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 29).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 29) and (ord(T) lt 58))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 58) and (ord(T) lt 87))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 87) and (ord(T) lt 116))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 116) and (ord(T) lt 145))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 145) and (ord(T) lt 175))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 175) and (ord(T) lt 204))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 204) and (ord(T) lt 233))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 233) and (ord(T) lt 262))..                BC_R(T) =e= BC_R(T+1);
    BC_R10(T)$((ord(T) gt 262) and (ord(T) lt 291))..                BC_R(T) =e= BC_R(T+1);
    BC_R11(T)$((ord(T) gt 291) and (ord(T) lt 320))..                BC_R(T) =e= BC_R(T+1);
    BC_R12(T)$((ord(T) gt 320) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
