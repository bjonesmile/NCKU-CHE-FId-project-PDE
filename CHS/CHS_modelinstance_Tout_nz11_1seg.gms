...
*    sym_bc(T).. bc_L(T) =e= bc_R(T);
    ...
    BC_L1(T)$(ord(T) lt 31).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 31) and (ord(T) lt 63))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 63) and (ord(T) lt 95))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 95) and (ord(T) lt 127))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 127) and (ord(T) lt 159))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 159) and (ord(T) lt 190))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 190) and (ord(T) lt 222))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 222) and (ord(T) lt 254))..                BC_L(T) =e= BC_L(T+1);
    BC_L9(T)$((ord(T) gt 254) and (ord(T) lt 286))..                BC_L(T) =e= BC_L(T+1);
    BC_L10(T)$((ord(T) gt 286) and (ord(T) lt 318))..                BC_L(T) =e= BC_L(T+1);
    BC_L11(T)$((ord(T) gt 318) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 31).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 31) and (ord(T) lt 63))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 63) and (ord(T) lt 95))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 95) and (ord(T) lt 127))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 127) and (ord(T) lt 159))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 159) and (ord(T) lt 190))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 190) and (ord(T) lt 222))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 222) and (ord(T) lt 254))..                BC_R(T) =e= BC_R(T+1);
    BC_R9(T)$((ord(T) gt 254) and (ord(T) lt 286))..                BC_R(T) =e= BC_R(T+1);
    BC_R10(T)$((ord(T) gt 286) and (ord(T) lt 318))..                BC_R(T) =e= BC_R(T+1);
    BC_R11(T)$((ord(T) gt 318) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
