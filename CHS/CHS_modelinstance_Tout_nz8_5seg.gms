...
*   For_u(X,T)$(region(X,T)) ..  u(X,T+1) =e= u(X,T-1)+alpha(T)*r1*(u(X-1,T)-2*u(X,T)+u(X+1,T))-v*r2*(u(X+1,T)-u(X-1,T))-c*2*dt*(u(X,T)-k0) ;
    ...
    BC_L1(T)$(ord(T) lt 43).. BC_L(T) =e= BC_L(T+1);
    BC_L2(T)$((ord(T) gt 43) and (ord(T) lt 87))..                BC_L(T) =e= BC_L(T+1);
    BC_L3(T)$((ord(T) gt 87) and (ord(T) lt 131))..                BC_L(T) =e= BC_L(T+1);
    BC_L4(T)$((ord(T) gt 131) and (ord(T) lt 175))..                BC_L(T) =e= BC_L(T+1);
    BC_L5(T)$((ord(T) gt 175) and (ord(T) lt 218))..                BC_L(T) =e= BC_L(T+1);
    BC_L6(T)$((ord(T) gt 218) and (ord(T) lt 262))..                BC_L(T) =e= BC_L(T+1);
    BC_L7(T)$((ord(T) gt 262) and (ord(T) lt 306))..                BC_L(T) =e= BC_L(T+1);
    BC_L8(T)$((ord(T) gt 306) and (ord(T) lt 350))..                BC_L(T) =e= BC_L(T+1);
    BC_R1(T)$(ord(T) lt 43).. BC_R(T) =e= BC_R(T+1);
    BC_R2(T)$((ord(T) gt 43) and (ord(T) lt 87))..                BC_R(T) =e= BC_R(T+1);
    BC_R3(T)$((ord(T) gt 87) and (ord(T) lt 131))..                BC_R(T) =e= BC_R(T+1);
    BC_R4(T)$((ord(T) gt 131) and (ord(T) lt 175))..                BC_R(T) =e= BC_R(T+1);
    BC_R5(T)$((ord(T) gt 175) and (ord(T) lt 218))..                BC_R(T) =e= BC_R(T+1);
    BC_R6(T)$((ord(T) gt 218) and (ord(T) lt 262))..                BC_R(T) =e= BC_R(T+1);
    BC_R7(T)$((ord(T) gt 262) and (ord(T) lt 306))..                BC_R(T) =e= BC_R(T+1);
    BC_R8(T)$((ord(T) gt 306) and (ord(T) lt 350))..                BC_R(T) =e= BC_R(T+1);
