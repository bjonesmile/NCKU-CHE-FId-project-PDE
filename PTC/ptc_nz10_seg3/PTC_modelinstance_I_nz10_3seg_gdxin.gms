...
$gdxin Db_vertex.gdx
$load I_x12_vertex I_x3_vertex I_x45_vertex
$gdxin
...
*S,V
    ...
    I_uncertain_x1_1(t)  ..  I(t,'1','1') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x1_2(t)  ..  I(t,'1','2') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x1_3(t)  ..  I(t,'1','3') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x1_4(t)  ..  I(t,'1','4') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x1_5(t)  ..  I(t,'1','5') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x2_1(t)  ..  I(t,'2','1') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x2_2(t)  ..  I(t,'2','2') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x2_3(t)  ..  I(t,'2','3') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    I_uncertain_x2_4(t)  ..  I(t,'2','4') =e= I_n(t)+300*FId*I_x12_vertex(t) ;
    ...
    I_uncertain_x4_2(t)  ..  I(t,'4','2') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x4_3(t)  ..  I(t,'4','3') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x4_4(t)  ..  I(t,'4','4') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x4_5(t)  ..  I(t,'4','5') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x5_1(t)  ..  I(t,'5','1') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x5_2(t)  ..  I(t,'5','2') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x5_3(t)  ..  I(t,'5','3') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x5_4(t)  ..  I(t,'5','4') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
    I_uncertain_x5_5(t)  ..  I(t,'5','5') =e= I_n(t)+300*FId*I_x45_vertex(t) ;
