...
*S,V
	...
	m1(t)$(ord(t) lt 40).. m(t) =e= m(t+1);
	m2(t)$((ord(t) gt 40) and (ord(t) lt 80)).. m(t) =e= m(t+1);
	m3(t)$((ord(t) gt 80) and (ord(t) lt 120)).. m(t) =e= m(t+1);
	m4(t)$((ord(t) gt 120) and (ord(t) lt 160)).. m(t) =e= m(t+1);
	m5(t)$((ord(t) gt 160) and (ord(t) lt 200)).. m(t) =e= m(t+1);
	m6(t)$((ord(t) gt 200) and (ord(t) lt 240)).. m(t) =e= m(t+1);
