...
$gdxin Db_vertex.gdx
$load I_x1_vertex I_x2_vertex I_x3_vertex I_x4_vertex I_x5_vertex
$gdxin
...
sets
    ...
    bc_out_region(t,x,j)$(ord(x) = card(x) and ord(j) = card(j)) = yes;
...
*S,V
    ...
    I_uncertain_x1_1(t)  ..  I(t,'1','1') =e= I_n(t)+300*FId*I_x1_vertex(t) ;
    I_uncertain_x1_2(t)  ..  I(t,'1','2') =e= I_n(t)+300*FId*I_x1_vertex(t) ;
    I_uncertain_x1_3(t)  ..  I(t,'1','3') =e= I_n(t)+300*FId*I_x1_vertex(t) ;
    I_uncertain_x1_4(t)  ..  I(t,'1','4') =e= I_n(t)+300*FId*I_x1_vertex(t) ;
    I_uncertain_x1_5(t)  ..  I(t,'1','5') =e= I_n(t)+300*FId*I_x2_vertex(t) ;
    I_uncertain_x2_1(t)  ..  I(t,'2','1') =e= I_n(t)+300*FId*I_x2_vertex(t) ;
    I_uncertain_x2_2(t)  ..  I(t,'2','2') =e= I_n(t)+300*FId*I_x2_vertex(t) ;
    I_uncertain_x2_3(t)  ..  I(t,'2','3') =e= I_n(t)+300*FId*I_x2_vertex(t) ;
    I_uncertain_x2_4(t)  ..  I(t,'2','4') =e= I_n(t)+300*FId*I_x2_vertex(t) ;
    I_uncertain_x2_5(t)  ..  I(t,'2','5') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x3_1(t)  ..  I(t,'3','1') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x3_2(t)  ..  I(t,'3','2') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x3_3(t)  ..  I(t,'3','3') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x3_4(t)  ..  I(t,'3','4') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x3_5(t)  ..  I(t,'3','5') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x4_1(t)  ..  I(t,'4','1') =e= I_n(t)+300*FId*I_x3_vertex(t) ;
    I_uncertain_x4_2(t)  ..  I(t,'4','2') =e= I_n(t)+300*FId*I_x4_vertex(t) ;
    I_uncertain_x4_3(t)  ..  I(t,'4','3') =e= I_n(t)+300*FId*I_x4_vertex(t) ;
    I_uncertain_x4_4(t)  ..  I(t,'4','4') =e= I_n(t)+300*FId*I_x4_vertex(t) ;
    I_uncertain_x4_5(t)  ..  I(t,'4','5') =e= I_n(t)+300*FId*I_x4_vertex(t) ;
    I_uncertain_x5_1(t)  ..  I(t,'5','1') =e= I_n(t)+300*FId*I_x4_vertex(t) ;
    I_uncertain_x5_2(t)  ..  I(t,'5','2') =e= I_n(t)+300*FId*I_x5_vertex(t) ;
    I_uncertain_x5_3(t)  ..  I(t,'5','3') =e= I_n(t)+300*FId*I_x5_vertex(t) ;
    I_uncertain_x5_4(t)  ..  I(t,'5','4') =e= I_n(t)+300*FId*I_x5_vertex(t) ;
    I_uncertain_x5_5(t)  ..  I(t,'5','5') =e= I_n(t)+300*FId*I_x5_vertex(t) ;
	
    m1(t)$(ord(t) lt 24).. m(t) =e= m(t+1);
	m2(t)$((ord(t) gt 24) and (ord(t) lt 48)).. m(t) =e= m(t+1);
	m3(t)$((ord(t) gt 48) and (ord(t) lt 72)).. m(t) =e= m(t+1);
	m4(t)$((ord(t) gt 72) and (ord(t) lt 96)).. m(t) =e= m(t+1);
	m5(t)$((ord(t) gt 96) and (ord(t) lt 120)).. m(t) =e= m(t+1);
	m6(t)$((ord(t) gt 120) and (ord(t) lt 144)).. m(t) =e= m(t+1);
	m7(t)$((ord(t) gt 144) and (ord(t) lt 168)).. m(t) =e= m(t+1);
	m8(t)$((ord(t) gt 168) and (ord(t) lt 192)).. m(t) =e= m(t+1);
	m9(t)$((ord(t) gt 192) and (ord(t) lt 216)).. m(t) =e= m(t+1);
	m10(t)$((ord(t) gt 216) and (ord(t) lt 240)).. m(t) =e= m(t+1);
